...
<html>
	...
	<?php
		...
		while($donnees = $req2->fetch()){
			...
			echo '<li><a href="demandeEmprunt.php?uti_id=', htmlspecialchars($donnees['UTI_ID']), '&sup_id=', $donnees['SUP_ID'], '">', htmlspecialchars($donnees['UTI_ID']), ' (', htmlspecialchars($donnees['SUP_NOM']), ')', '</a></li>';
